...
namespace JAM.Shared.Systems.Resource
{
    ...
    /// </summary>
    public class HealthResourceSystem : MonoBehaviour
    {
        [SerializeField] private bool _useView;
        [SerializeField] private HealthResourceSystemView _resourceSystemView;

        private ResourceSystem _entityHealthSystem;
